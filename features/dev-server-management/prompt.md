...
10. Output `<promise>success</promise>` if and only if the task is fully complete and verified.
...
This exact tag is required for the CLI to mark the task as complete.
